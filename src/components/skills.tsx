...
//           <FaTools className="text-4xl text-blue-600 dark:text-blue-400" />
//           <h2 className="text-3xl font-bold text-gray-800 dark:text-white tracking-wide">
//             My Skills
//           </h2>
//         </div>
//         <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-y-14 gap-x-14 justify-items-center px-2 py-2">
...
const images: ImageData[] = [
  ...
  { src: "/assests/skills/js.webp", alt: "JavaScript", tooltip: "JavaScript" },
  {
    src: "/assests/skills/kubernetes.webp",
    alt: "Kubernetes",
    tooltip: "Kubernetes",
  },
  { src: "/assests/skills/mongoDB.webp", alt: "MongoDB", tooltip: "MongoDB" },
  ...
  { src: "/assests/skills/nodejs.webp", alt: "Node.js", tooltip: "Node.js" },
  {
    src: "/assests/skills/photoshop.webp",
    alt: "Photoshop",
    tooltip: "Photoshop",
  },
  {
  ...
  {
    src: "/assests/skills/solidity.webp",
    alt: "Solidity",
    tooltip: "Solidity",
  },
  { src: "/assests/skills/python.webp", alt: "Python", tooltip: "Python" },
