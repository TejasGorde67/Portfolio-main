              ...
              >
                <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-transparent dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-[550px] rounded-xl p-6 border">
                  ...
                  <CardItem
                    ...
                    className="text-xl font-bold text-neutral-600 dark:text-white"
                  >
                    DataCanvas - interactive web based notebook application for
                    data analysis
                  </CardItem>
                  <CardItem
                    as="p"
                    ...
                    className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
                  >
                    React, TypeScript, Yjs, Monaco Editor, React Markdown,
                    Recharts, React Virtuoso
                  </CardItem>
                  <CardItem
                    translateZ="100"
                    rotateX={0}
                  ...
                  <div className="flex justify-between items-center mt-20">
                    ...
                    <CardItem
                      ...
                      translateX={40}
                      as="a"
                      href="https://github.com/TejasGorde67/DataCanvas"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center px-4 py-2 text-white text-xl font-bold"
                    >
